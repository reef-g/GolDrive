...
class ChangePasswordDialog(wx.Dialog):
    def __init__(self, parent, title):
        super(ChangePasswordDialog, self).__init__(parent, title=title, size=(348, 230), pos=(960-174, 540-115))

        self.panel = wx.Panel(self)

        # Create two text boxes
        self.old_password_ctrl = wx.TextCtrl(self.panel, size=(308, -1), style=wx.TE_PROCESS_ENTER)
        self.new_password_ctrl = wx.TextCtrl(self.panel, size=(308, -1), style=wx.TE_PROCESS_ENTER)
        self.confirm_password_ctrl = wx.TextCtrl(self.panel, size=(308, -1), style=wx.TE_PROCESS_ENTER)
        ...
        entries.Add(self.old_password_ctrl, 0, wx.CENTER | wx.ALL, 5)
        entries.Add(wx.StaticText(self.panel, label="Enter new password:"), 0, wx.LEFT | wx.ALL)
        entries.Add(self.new_password_ctrl, 0, wx.CENTER | wx.ALL, 5)
        entries.Add(wx.StaticText(self.panel, label="Confirm password:"), 0, wx.LEFT | wx.ALL)
        entries.Add(self.confirm_password_ctrl, 0, wx.CENTER | wx.ALL, 5)
        entries.AddSpacer(5)
        sizer.Add(entries, 0, wx.CENTER | wx.ALL)

        buttons_sizer = wx.BoxSizer(wx.HORIZONTAL)
        buttons_sizer.Add(self.ok_button, 0, wx.ALIGN_RIGHT | wx.ALL)
        buttons_sizer.AddSpacer(10)
        buttons_sizer.Add(self.cancel_button, 0, wx.ALIGN_RIGHT | wx.ALL)
