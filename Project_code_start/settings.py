class ClassSettings:
    def __init__(self):
        ...
        self.USER_FILES_PATH = r"D:\!ReefGold\Project_code_start\UserGraphics".replace("\\", '/')
...
class HomeSettings():
    def __init__(self):
        ...
        self.USER_FILES_PATH = r"C:\Users\reefg\PycharmProjects\Project_code_start\UserGraphics".replace("\\", '/')
